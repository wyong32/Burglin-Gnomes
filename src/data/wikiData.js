export default [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Gnome-World Base Objects', parent: 'Base Building', scope: 'Tree, mushroom house, storage, purple crystal, bell, and crafting well.', path: '/base-building#base-objects' },
